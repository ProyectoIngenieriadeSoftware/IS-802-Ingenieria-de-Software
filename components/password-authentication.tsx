...
if (userData.roles.includes("interno")) {
  url = `${API_URL}/personas/login`;   // 🔵 login de internos
} else {
  url = `${API_URL}/visitas/login`;    // 🟡 login de visitantes
}
          ...
          <div className="space-y-6">
            <div className="space-y-2 text-center">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <p className="text-sm text-gray-600 mb-1">DNI ingresado:</p>
